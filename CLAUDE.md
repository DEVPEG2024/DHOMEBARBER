...
- **Styles de barbe** (`SNAP_BEARD_STYLES`) : même mécanique que la palette, quatre pastilles à emoji (barbe fournie, barbe de 3 jours, moustache, rasé de près) qui relancent la lentille barbe avec `launchParams: { style }`
