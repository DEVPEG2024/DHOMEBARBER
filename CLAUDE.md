...
- Dernier état connu (2 septembre 2026) : Android 1.0.1 (versionCode 2), iOS 1.0 (build 4, soumis à la review Apple). Incrémenter `versionCode` / `CURRENT_PROJECT_VERSION` avant chaque envoi aux stores.
